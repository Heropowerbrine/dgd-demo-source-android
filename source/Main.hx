...
class Main extends Sprite
{
	...
	public static var ammo:Array<Int> = [4, 5, 6, 7, 8, 9];
	...
	public static var gfxHudBF:Array<Dynamic> = [
		[0, 1, 2, 3],
		[0, 1, 5, 2, 3],
		[0, 2, 3, 0, 1, 3],
		[0, 2, 3, 5, 0, 1, 3],
	...
	public static var charDir:Array<String> = ['LEFT', 'DOWN', 'UP', 'RIGHT', 'UP', "SPACE"];
